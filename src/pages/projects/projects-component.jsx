        ...
        <div className="projects-container">
            ...
            <div className="projects-wrapper">
                <div className="project one">
                    ...
                    <Link to="https://github.com/MariaChira/web-portofolio"><button class="project-code">View code</button></Link>
                </div>
                ...
                <img className='project-image' src='assets/images/beauty-products.jpg' alt='beauty-products'></img>
                    ...
                    <Link to="https://github.com/MariaChira/Medical-website"><button class="project-code">View code</button></Link></div>
                ...
                <img className='project-image' src='assets/images/eth.png' alt='ethereum'></img>
                    ...
                    <Link to="https://github.com/MariaChira/Gecko-app"><button class="project-code">View code</button></Link>
                </div>
                ...
                <img className='project-image' src='assets/images/math.jpg' alt='mathematics'></img>
                    ...
                    <Link to="https://github.com/MariaChira/Math-Game"><button class="project-code">View code</button></Link>
                </div>
                ...
                <img className='project-image' src='assets/images/currency.png' alt='money'></img>
                    ...
                    <Link to="https://github.com/MariaChira/Budget--app"><button class="project-code">View code</button></Link>
                </div>
            </div>
        </div>
    )
